...
class ActiveCustomer extends StatefulWidget {
  const ActiveCustomer({Key? key, required this.name, required this.totalExpenditure, required this.totalLoan, required this.function}) : super(key: key);
  final String name;
                      ...
                      child: Material(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Search Active Customer',
                            hintStyle:  TextStyle(
